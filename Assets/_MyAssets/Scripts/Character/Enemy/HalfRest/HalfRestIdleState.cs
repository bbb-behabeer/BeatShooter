...
namespace _MyAssets.Scripts.Character.Enemy.HalfRest
{
    ...
    /// </summary>
    [Serializable]
    public class HalfRestIdleState : IStateBase
    {
        ...
        public HalfRestIdleState(HalfRestCtl ctl, HalfRestStateMachine stateMachine)
        {
            _ctl = ctl;
        ...
        public void OnStateFixedUpdate()
        {
            ...
            if (!idle)
            {
                // アイドル状態が終わったら
                // ステート遷移
                var state = new HalfRestApproachState(_ctl, _stateMachine);
